...
def all_contracts(request):
	...
	if request.method == "GET":
		...
		#return render(request,'contract_list.html', {'all_contracts': all_contracts})
...
@permission_required('hr_contracts.delete_changemodel', login_url='login') 
def delete_contract(request, contract_id):
	...
	# 	print('delete_contract POST call')
