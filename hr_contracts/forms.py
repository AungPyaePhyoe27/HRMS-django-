...
class ContractForm(forms.Form):
	...
	create_date = forms.DateTimeField(label='Create Date', widget=widgets.DateTimeInput(attrs={'type':'datetime-local', 'class': 'form-control'}))
	attachment = forms.ImageField(label='Upload Attachment', widget=widgets.ClearableFileInput(), required=False)
	# , widget=widgets.ClearableFileInput(attrs={'class': 'form-control'})
